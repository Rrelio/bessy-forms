...
<form action="" class="mt-3">
    ...
    <div class="row mb-6">
        ...
        <div class="col-lg-8 fv-row fv-plugins-icon-container">
            <input type="text" name="place_of_death" id="place-of-death"
                class="form-control form-control-lg form-control-solid" placeholder="Place of Marriage" value="">
            <div class="fv-plugins-message-container invalid-feedback"></div>
        </div>
    </div>
    <hr>
    ...
    <div class="alert alert-primary d-flex align-items-center p-5">
        ...
        <div class="d-flex flex-column">
            ...
            <span><strong>Requester (in hierarchical order) can either be the document owner, spouse of owner, with authorization letter - sons/daughters or an authorized representative of the owner.</strong></span>
        </div>
    </div>
